 ...
 *
 * Уточнение после имени считается тем же подпунктом: на задаче из частей естественная форма -
 * «**сделано в части 4:**», и строгое имя объявляло её отсутствующей на каждом ходе.
 */
