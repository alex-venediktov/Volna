...
| [volna](volna/INDEX.md) | узел · 31 | профиль проекта, автопроход, длинная задача, активная задача и гейт | порядок ×8, ограничение ×7, договорённость ×6 | analyze, spec, plan, implement, advocate, unit-tests, visual, capture, deliver, close, cleanup, intake | - |