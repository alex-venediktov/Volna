...
| [implement](INDEX--implement.md) | узел · 10 | автопроход, длинная задача, возврат к задаче, возврат к этапу | порядок ×4, ограничение ×3, гейт | analyze, plan, implement, advocate, unit-tests, visual, capture, deliver, close, intake | - |
...
| [capture](INDEX--capture.md) | узел · 15 | автопроход, длинная задача, архивные журналы, возврат к задаче | порядок ×6, договорённость ×3, ограничение ×2 | analyze, plan, implement, capture, deliver, close, cleanup, intake | - |
