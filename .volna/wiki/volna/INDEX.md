...
| [implement](INDEX--implement.md) | узел · 18 | автопроход, длинная задача, адвокат на задаче без кода, возврат к задаче | ограничение ×5, порядок ×5, приём ×3 | analyze, spec, plan, implement, advocate, unit-tests, visual, capture, deliver, close, intake | - |
