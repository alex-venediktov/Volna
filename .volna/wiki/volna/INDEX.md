...
| [implement](INDEX--implement.md) | узел · 13 | автопроход, длинная задача, возврат к задаче, возврат к этапу | порядок ×5, ограничение ×3, гейт ×2 | analyze, plan, implement, advocate, unit-tests, visual, capture, deliver, close, intake | - |
...
| [capture](INDEX--capture.md) | узел · 18 | автопроход, длинная задача, архивные журналы, возврат к задаче | порядок ×7, договорённость ×3, гейт ×2 | analyze, plan, implement, capture, deliver, close, cleanup, intake | - |
