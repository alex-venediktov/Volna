...
| [implement](INDEX--implement.md) | узел · 9 | автопроход, длинная задача, возврат к задаче, возврат к этапу | ограничение ×3, порядок ×3, гейт | analyze, plan, implement, advocate, unit-tests, visual, capture, deliver, close, intake | - |
...
| [capture](INDEX--capture.md) | узел · 14 | автопроход, длинная задача, архивные журналы, возврат к задаче | порядок ×5, договорённость ×3, ограничение ×2 | analyze, plan, implement, capture, deliver, close, cleanup, intake | - |
