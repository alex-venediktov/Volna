...
открывает **новую итерацию**, а прошлые записи журнала остаются как были. Ход работы кончается
одной строкой с готовой командой следующего шага **без параметров** — её принимает `Tab`
у поля ввода (команду с пробелом внутри подсказка не показывает).
