...
| **W3** | интеграции: CLI над трекером, `/volna:recall` | **написано**, 52 проверки проходят |
| W4 | onboarding для команды, документ по стоимости | **написано**, осталось закрепить версию тегом |
...
| **W2 и W3 не прогнаны на живой задаче** | hooks и CLI покрыты тестами (27 и 52 проверки), но боевой проверки ещё не было |
