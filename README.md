...
| **W2** | hooks: шапка сессии, гейт на commit/push, PreCompact | **проверено в живой работе**, 27 проверок проходят |
| **W3** | интеграции: CLI над трекером, `/volna:recall` | **проверено в живой работе**, 52 проверки проходят |
| **W4** | onboarding для команды, документ по стоимости, ограничения | **закрыто**, версия закреплена тегом `v0.1.5` |
